...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "jjphilipp-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/jjphilipp"
  #   chef.validation_client_name = "jjphilipp-validator"
  #   chef.validation_key_path = ".chef/jjphilipp-validator.pem"
  # end
end
